...
function generateRiskProfile(la) {
  ...
  let business = purpose.includes('house');
  ...
  var summaryText = highlightText `Dear ${la.ApplicantName}, <br> ${reviewText}. 
    <br> Your risk profile is ${riskProfile}.
    <br> Your unique application code is ${applicationCode}`;
